...
interface ProvidersIntentDefaultPayloadAttributes {
  id: number;
  user_ref_id: string;
  name: string;
  provider: string;
...
class ProvidersIntentDefaultPayload
  extends Model<ProvidersIntentDefaultPayloadAttributes>
  implements ProvidersIntentDefaultPayloadAttributes {
  public id!: number;
...
function init(sequelize: Sequelize) {
  ProvidersIntentDefaultPayload.init(
    {
    ...
    {
      sequelize,
      modelName: 'ProvidersIntentDefaultPayload',
      tableName: 'providers_intent_default_payloads',
      underscored: true,
    },
  );

  return ProvidersIntentDefaultPayload;
}
